...
(function (overlay) {
    ...
    })(OverlayIcons = overlay.OverlayIcons || (overlay.OverlayIcons = {}));
    var OverlayBounds = (function () {
        function OverlayBounds(x1, y1, x2, y2) {
            if (x1 === void 0) { x1 = 0; }
            if (y1 === void 0) { y1 = 0; }
            if (x2 === void 0) { x2 = 0; }
            if (y2 === void 0) { y2 = 0; }
        ...
        OverlayBounds.prototype.set = function (x1, y1, x2, y2) {
            if (x1 === void 0) { x1 = 0; }
            if (y1 === void 0) { y1 = 0; }
            if (x2 === void 0) { x2 = 0; }
            if (y2 === void 0) { y2 = 0; }
    ...
    overlay.OverlayBounds = OverlayBounds;
    /**
     * Renders an optional icon and text into a canvas
     */
    var Overlay = (function () {
        function Overlay(x, y, text, icon, options) {
            ...
            this.text = text;
            this.icon = icon;
            this.options = utils.applyDefaults(options || {}, {
                fontSize: 12,
        ...
        Overlay.prototype.render = function (context) {
            var options = this.options;
            var iconWidth = 0, textWidth = 0, totalWidth, iconHeight = 0, textHeight = 0, totalHeight, lineWidths;
            context.save();
            ...
            if (this._text != null) {
                context.save();
                var drawX = originX + iconWidth;
                var drawY = originY + (totalHeight - textHeight) / 2;
                context.fillStyle = options.textColour;
                for (var a = 0, length_1 = this.lines.length; a < length_1; a++) {
                    var line = this.lines[a];
                    var width = lineWidths[a];
                    var x = options.textAlign == 'right'
                        ? textWidth - width
        ...
        Object.defineProperty(Overlay.prototype, "text", {
            /*
             *** Getters, Setters
             */
            get: function () {
        ...
        Overlay.bounds = new OverlayBounds();
        return Overlay;
    }());
